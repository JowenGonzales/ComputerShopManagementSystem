...
<head>
    ...
    <title>ADMIN | Computer Shop Management System</title>
    ...
    <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar">
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFour"
               aria-expanded="true" aria-controls="collapseTwo">
                <i class="bi bi-box-seam ml-1"></i>
                <span>Pricing and Packages</span>
            </a>
            <div id="collapseFour" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Pricing and Packages:</h6>
                    <a class="collapse-item" href="buttons.html">Set Pricing </a>
                    <a class="collapse-item" href="cards.html">Create Packages  </a>
                    <a class="collapse-item" href="cards.html">Manage Promotions</a>
                    <a class="collapse-item" href="cards.html">Monitor Revenue </a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            <a class="nav-link collapsed" href="#" data-toggle="collapse" data-target="#collapseFive"
               aria-expanded="true" aria-controls="collapseTwo">
                <i class="bi bi-calendar-check ml-1"></i>
                <span>Reservation</span>
            </a>
            <div id="collapseFive" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Reservations:</h6>
                    <a class="collapse-item" href="buttons.html">Adding New </a>
                    <a class="collapse-item" href="cards.html">Edit Existing  </a>
                    <a class="collapse-item" href="cards.html">View Details</a>
                    <a class="collapse-item" href="cards.html">Listing of All </a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseSix" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    <h6 class="collapse-header">Sales and Reports</h6>
                    <a class="collapse-item" href="buttons.html">View Sales Reports</a>
                    <a class="collapse-item" href="cards.html">Analyze Usage Statistics</a>
                    <a class="collapse-item" href="cards.html">Monitor User Satisfaction</a>
                    <a class="collapse-item" href="cards.html">Identify Trends</a>
                </div>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div id="collapseSeven" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionSidebar">
                <div class="bg-white py-2 collapse-inner rounded">
                    ...
                    <a class="collapse-item" href="buttons.html">Manage Schedules</a>
                    <a class="collapse-item" href="cards.html">Attendance & Payroll</a>
                    <a class="collapse-item" href="cards.html">Monitor Performance</a>
                    <a class="collapse-item" href="cards.html">Set Up Training Programs</a>
                </div>
            </div>
        </li>
